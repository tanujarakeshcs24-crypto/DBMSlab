create database JobDetails_Tanuja;
use JobDetails_Tanuja;
...
-- List employees with their department name & location
...
SELECT p.PNAME, COUNT(a.EMPNO) AS HEADCOUNT
FROM PROJECT p
LEFT JOIN ASSIGNED_TO a ON p.PNO = a.PNO
GROUP BY p.PNAME;

-- Department-wise average & maximum salary
SELECT d.DNAME, 
...
-- Total incentives earned by each employee (lifetime)
SELECT e.EMPNO, e.ENAME, 
...
-- Employees working on project “Alpha Project”
SELECT e.EMPNO, e.ENAME
FROM EMPLOYEE e
